...
for (yearindex in 1:length(Years))
{
    ...
    #Applico il modello
    lambda = 10^2
    Rifiuti = smooth.FEM.fd.CovarCI(Z,X,Rifiutifd,10^2,c(0.95,1-0.05/14))
    
    #Ora salvo i valori che mi servono
...
plot(Years,betahat,pch=8,main="Intervalli di confidenza di beta",ylim=c(-0.005,0.025))
...
#Cerco di scaricare l'immagine inserendo il centro
...
#Oppure inserendo il bounding box
bb<-qbbox(c(47,44.5,44.5),c(10,10,13.2))
