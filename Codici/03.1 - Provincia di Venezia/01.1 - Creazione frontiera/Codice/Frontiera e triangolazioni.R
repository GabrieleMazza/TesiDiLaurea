...
legend("bottomleft", legend=c("Dati","Stima"), col=c("black","red"), lty=c(0,1),lwd=c(1,2),pch=c(1,NA))
dev.off()
...
legend("bottomright", legend=c("Reale","Stimata"), col=c("black","red"), lty=1,lwd=2)
dev.off()
