...
xVeneto=c(xVeneto[1:83],12.26,12.27,12.31,12.31,xVeneto[85:length(xVeneto)])
yVeneto=c(yVeneto[1:83],45.19,45.23,45.235,45.16,yVeneto[85:length(yVeneto)])
...
#identify(xG,yG)
IDKeep<-c(IDKeep,29,30,31,34,36)
IDChoose<-c(IDChoose,32,33)
#Siamo a 8, 31 mancanti
...
points(xG,yG,pch=16,col="red")
#identify(xG,yG)
IDKeep<-c(IDKeep,27,25,28,26,11,12,13)
#Siamo a 15, 24 mancanti
...
points(xG,yG,pch=16,col="red")
#identify(xG,yG)
IDDelete<-c(IDDelete,22,23,24)
#Siamo a 18,21 mancanti
...
points(xG,yG,pch=16,col="red")
#identify(xG,yG)
IDKeep<-c(IDKeep,24,15,16)
IDChoose<-c(IDChoose,14,17,18,19)
#Siamo a 25,14 mancanti
...
points(xG,yG,pch=16,col="red")
#identify(xG,yG)
IDKeep<-c(IDKeep,6,7,8)
IDChoose<-c(IDChoose,9,1,2,3,4,5,10,38)
#Siamo a 35,4 mancanti
...
#identify(xG,yG)
IDKeep<-c(IDKeep,6,7,8)
IDChoose<-c(IDChoose,35,37,39)
#Siamo a 37,2 mancanti


plot(x,y,col="white",xlim=c(12.25,12.5),ylim=c(44.9,45.2))
for (ne in 1:dim(Triang)[1])
{
    polygon(c(x[Triang[ne,1]],x[Triang[ne,2]],x[Triang[ne,3]]),c(y[Triang[ne,1]],y[Triang[ne,2]],y[Triang[ne,3]]))
}
