...
for(j in 1:length(TimePoints))
{
    ...
    ggmap(Map) + 
        ...
        scale_size_area(breaks=c(200,400,600,800,1000,1200,1400,1600,1800), "Rifiuti pro-capite", max_size=10) +
...
for(j in 1:length(TimePoints))
{
    ...
    ggmap(Map) + 
        ...
        scale_size_area(breaks=c(1,2,3,4,5,6,7,8), "PL pro-capite", max_size=10) +
        labs(title=paste("Dati anno ",TimePoints[j],sep="")) +
        theme(plot.title = element_text(size = rel(1.5), face="bold")) 
