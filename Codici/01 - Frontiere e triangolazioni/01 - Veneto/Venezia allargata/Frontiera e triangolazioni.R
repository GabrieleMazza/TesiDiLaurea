...
m=(45.463851-yVenezia[7])/(12.280237-xVenezia[7])
q=(yVenezia[14]-m*xVenezia[14])
provax3<-12.29
provay3<-m*provax3+q
provax4<-12.30
provay4<-m*provax4+q
...
xVeneto=c(xVeneto[1:90],12.26,12.27,12.31,12.31,xVeneto[92:length(xVeneto)])
yVeneto=c(yVeneto[1:90],45.19,45.23,45.235,45.16,yVeneto[92:length(yVeneto)])
...
#identify(xG,yG)
IDKeep<-c(IDKeep,40,47,39,43,44)
IDChoose<-c(IDChoose,41,42)
#Siamo a 7, 41 mancanti

#Devo eliminare i triangoli composti solo da punti di bordo
plot(x,y,col="white",xlim=c(12.25,12.35),ylim=c(45.3,45.5))
for (ne in 1:dim(Triang)[1])
{
    polygon(c(x[Triang[ne,1]],x[Triang[ne,2]],x[Triang[ne,3]]),c(y[Triang[ne,1]],y[Triang[ne,2]],y[Triang[ne,3]]))
}
...
points(xG,yG,pch=16,col="red")
#identify(xG,yG)
IDKeep<-c(IDKeep,17,33,34,35,36,37,38)
#Siamo a 14, 34 mancanti


#Devo eliminare i triangoli composti solo da punti di bordo
plot(x,y,col="white",xlim=c(12.30,12.37),ylim=c(45.4,45.46))
for (ne in 1:dim(Triang)[1])
{
    polygon(c(x[Triang[ne,1]],x[Triang[ne,2]],x[Triang[ne,3]]),c(y[Triang[ne,1]],y[Triang[ne,2]],y[Triang[ne,3]]))
}
...
points(xG,yG,pch=16,col="red")
#identify(xG,yG)
IDKeep<-c(IDKeep,12,13,14,15,16,25,26,27,28)
#Siamo a 23, 25 mancanti


plot(x,y,col="white",xlim=c(12.40,12.45),ylim=c(45,45.1))
for (ne in 1:dim(Triang)[1])
{
    polygon(c(x[Triang[ne,1]],x[Triang[ne,2]],x[Triang[ne,3]]),c(y[Triang[ne,1]],y[Triang[ne,2]],y[Triang[ne,3]]))
}
...
points(xG,yG,pch=16,col="red")
#identify(xG,yG)
IDDelete<-c(IDDelete,20,29,30)
#Siamo a 26,22 mancanti

plot(x,y,col="white",xlim=c(12.3,12.5),ylim=c(44.8,45.1))
for (ne in 1:dim(Triang)[1])
{
    polygon(c(x[Triang[ne,1]],x[Triang[ne,2]],x[Triang[ne,3]]),c(y[Triang[ne,1]],y[Triang[ne,2]],y[Triang[ne,3]]))
}
...
points(xG,yG,pch=16,col="red")
#identify(xG,yG)
IDKeep<-c(IDKeep,19,21,32)
IDChoose<-c(IDChoose,18,22,23,24,31)
#Siamo a 34,14 mancanti

plot(x,y,col="white",xlim=c(12.15,12.35),ylim=c(45.1,45.5))
for (ne in 1:dim(Triang)[1])
{
    polygon(c(x[Triang[ne,1]],x[Triang[ne,2]],x[Triang[ne,3]]),c(y[Triang[ne,1]],y[Triang[ne,2]],y[Triang[ne,3]]))
}
...
points(xG,yG,pch=16,col="red")
#identify(xG,yG)
IDKeep<-c(IDKeep,8,9,11)
IDChoose<-c(IDChoose,1,2,3,4,5,6,7,10)
#Siamo a 45,3 mancanti
...
points(xG,yG,pch=16,col="blue")
#identify(xG,yG)
IDKeep<-c(IDKeep,45,46,48)
#fine
