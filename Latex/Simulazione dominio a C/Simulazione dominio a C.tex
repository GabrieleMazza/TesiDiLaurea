...
\centering
	...
	\noalign{\hrule height 1.2pt}
	\end{tabular}
\caption{Analisi di $\mathrm{GCV}(\underline \lambda)$ per il dominio a forma di C, caso senza covariata}
\label{tab:DomC}
\end{table}
